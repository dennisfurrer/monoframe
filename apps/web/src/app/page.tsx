  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-10 p-8">
      <div className="text-center">
        ...
        <p className="mt-1 text-text-secondary">Production monorepo skeleton.</p>
      </div>

      <p className="text-sm text-text-muted">Examples below show integrated packages</p>
        ...
        <section className="flex flex-col gap-3">
          ...
          <Card variant="bordered" padding="md">
            <div className="flex flex-col gap-4">
              ...
              <Input type="text" size="sm" placeholder="With error" error="This field is required" />
        ...
        <section className="flex flex-col gap-3">
          ...
          <Card variant="bordered" padding="none">
            <EmptyState
              ...
              action={{ label: "Example CTA", onClick: () => {} }}
            />
          </Card>
        </section>
      </div>
